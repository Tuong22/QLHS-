...
<body>
	...
	<div class="page-wrapper" id="main-wrapper" data-layout="vertical"
		...
		<div class="body-wrapper">
			...
			<!-- Class start -->
			<div id="list-student-of-class" class="container-fluid list-student-of-class">
				<div class="row">
								...
								<div class="card-body">
									<div class="datatable-wrapper">
										...
										<div class="datatablefooter justify-content-between">
											...
											<button class="btn btn-primary list-student-of-class-confirm-btn"><a href = "./index.jsp">Xác
											nhận</a></button>
										</div>
									</div>
								</div>
